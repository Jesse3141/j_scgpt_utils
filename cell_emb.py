...
def embed_data(
    ...
    Args:
        adata_or_file (Union[AnnData, PathLike])  #load and examine the data at data/brca_scrna_epithelial.h5ad
    adata = sc.read_h5ad('data/brca_scrna_epithelial.h5ad')
    ...
    #prep args for embed:
    embed_args = {'adata_or_file': adata,
                   'model_dir':'/modles/scGPT_pancancer/',
    ...
    cell_embbed = embed_data(**embed_args): The AnnData object or the path to the
            AnnData object.
...
if __name__=='__main__':
    ...
    embed_args = {'adata_or_file': my_adata,
                  ...
                  'cell_type_key': "oncosig_label_ERBB2",
                  'gene_col': "gene_hgnc",
                  'max_length': 1500,
                  'batch_size': 1,
                  'obs_to_save': None,
...
# poetry add anndata numpy scanpy tqdm wandb json os typing